...
export const BELENTANI_MASTER_DOSSIER = {
  ...
  subtitle:
    "Dossier mitológico, biográfico y operativo de la Dimensión Zion y la Era de Judas",
  overview:
    "Belentani no es una entelequia publicitaria ni un proyecto efímero; es un sistema soberano donde convergen la música, la simulación, la filosofía de la traición y la persistencia de la identidad a través de la máquina.",
  chapters: [
    {
      number: "01",
