...
export const LORE_DATABASE: LoreNode[] = [
  {
    ...
    category: "Cosmology",
    summary: "El territorio cuántico donde Belentani opera, situado más allá del ruido de la industria musical tradicional y operado mediante protocolos de despersonalización.",
    content: [
  ...
  },
  {
    ...
    category: "Characters",
    summary: "Lucas (Duck), productor musical desde 2022 y artífice invisible detrás de la ingeniería sonora, la producción ejecutiva y el management del proyecto.",
    content: [
  ...
  },
  {
    ...
    category: "Eras",
    summary: "La fase actual del proyecto donde la traición se reinterpreta como un contrato de diseño: asumir el rol del villano necesario para que la historia colectiva avance.",
    content: [
  ...
  },
  {
    ...
    category: "Characters",
    summary: "La entidad encargada de custodiar la integridad del código fuente y proteger el artefacto central de las interferencias externas.",
    content: [
  ...
  },
  {
    ...
    category: "Characters",
    summary: "El símbolo primario de resistencia, refugio y continuidad emocional en medio del frío paisaje de la tecnología y el cálculo algorítmico.",
    content: [
  ...
  },
  {
    ...
    category: "Characters",
    summary: "La encarnación de la intuición anticipada, la lucidez prematura y la audacia de mirar el futuro sin temor a la obsolescencia.",
    content: [
  ...
  },
  {
    ...
    category: "Philosophy",
    summary: "El principio rector que dicta que si no existe un registro documental o estético que conecte dos puntos, la conexión no pertenece a la realidad oficial.",
    content: [
