        ...
        <div className="flex flex-col justify-between gap-10 border-b border-[var(--border)] pb-8 md:flex-row md:items-end">
          <div className="fade-up">
            ...
            <h1 className="section-title mt-7 max-w-[640px]">
              Revisión de 100 pasos y limpieza de archivo.
            </h1>
            <p className="mono-copy mt-4 max-w-[500px] text-[#96918a]">
              Protocolo de verificación exhaustiva en 10 bloques operativos.
            </p>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 lg:grid-cols-2">
          {AUDIT_100_BLOCKS.map(block => (
            <div
              ...
              className="border border-[var(--border)] bg-[#101010] p-6 flex flex-col justify-between"
            >
              <div>
                ...
                <h2 className="mt-3 text-xl font-medium tracking-[-0.03em] text-[#e7e1d8]">
                  {block.title}
                </h2>
              ...
              <div className="mt-6 border-t border-[var(--border)] pt-4 font-mono text-xs text-[#96918a]">
                <strong className="text-[#c5bfb6]">Criterio:</strong>{" "}
                {block.verificationCriteria}
              </div>
            </div>
          ))}
        </div>
