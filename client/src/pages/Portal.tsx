  ...
  return (
    <div className="relative w-full min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-20 pt-24 px-6 pb-12 max-w-4xl mx-auto text-center">
        <h1 className="text-5xl font-black text-red-500 mb-4" style={{ textShadow: "0 0 20px rgba(239, 68, 68, 0.6)" }}>PORTAL</h1>
        <p className="text-gray-400 font-mono">Chat interactivo con comandos ocultos y efectos visuales</p>
      </div>
    </div>
  )
}
